...
Gem::Specification.new do |s|
  ...
  s.files = [".document", ".gitignore", "History.rdoc", "LICENSE", "README.rdoc", "Rakefile", "TODO", "VERSION", "lib/rack-rewrite.rb", "lib/rack-rewrite/rule.rb", "rack-rewrite.gemspec", "test/geminstaller.yml", "test/rack-rewrite_test.rb", "test/rule_test.rb", "test/test_helper.rb"]
